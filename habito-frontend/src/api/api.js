...
// export const getHabitLogs = (habit_id) =>
//   API.get(`/habit_logs/${habit_id}`);

// export const addHabitLog = (data) =>
//   API.post("/add_habit_log", data);

// export const deleteHabitLog = (log_id) =>
//   API.delete(`/delete_habit_log/${log_id}`);
