    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-aqua-50 via-white to-teal-50">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-20 right-10 w-24 h-24 bg-aqua-200/30 rounded-full blur-2xl"
        />
        <motion.div
          animate={{ y: [0, 20, 0] }}
          transition={{ duration: 5, repeat: Infinity }}
          className="absolute bottom-20 left-10 w-32 h-32 bg-teal-200/30 rounded-full blur-2xl"
        />
      </div>
      ...
      >
        ...
        >
          ...
          <p className="text-gray-500 mt-1">Start your journey to better habits</p>
        </motion.div>
